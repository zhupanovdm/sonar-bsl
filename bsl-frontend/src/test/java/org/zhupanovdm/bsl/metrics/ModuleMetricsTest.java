...
public class ModuleMetricsTest {
    ...
    public void statements() {
        ModuleMetrics metrics = new ModuleMetrics(TestUtils.parse("/samples/metrics/Statements.bsl"));
    ...
    public void functions() {
        ModuleMetrics metrics = new ModuleMetrics(TestUtils.parse("/samples/metrics/Functions.bsl"));
