...
public class ModuleMetricsTest {
    ...
    public void statements() {
        ModuleMetrics metrics = new ModuleMetrics(TestUtils.parseFile("/samples/metrics/Statements.bsl"));
    ...
    public void functions() {
        ModuleMetrics metrics = new ModuleMetrics(TestUtils.parseFile("/samples/metrics/Functions.bsl"));
