...
public class ModuleMetricsTest {
    ...
    public void statements() {
        ...
        scan(moduleFile("/samples/metrics/Statements.bsl"), subscriber);
    ...
    public void functions() {
        ...
        scan(moduleFile("/samples/metrics/Functions.bsl"), subscriber);
    ...
    public void comments() {
        ...
        scan(moduleFile("/samples/metrics/Comments.bsl"), subscriber);
    ...
    public void linesOfCode() {
        ...
        scan(moduleFile("/samples/metrics/LinesOfCode.bsl"), subscriber);
